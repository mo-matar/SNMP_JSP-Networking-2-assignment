...
public class SignInFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        responseTextArea = new java.awt.TextArea();
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(responseTextArea, javax.swing.GroupLayout.PREFERRED_SIZE, 434, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(174, 174, 174)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(responseTextArea, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void sendToServlet() {
        ...
        try {
            //1. prepare the post method to send the credentials to the server (by servlet or jsp)
            ...
            //2. now write the data that was read from the textfields to the server
            try (OutputStream os = myConn.getOutputStream()) {
                byte[] input = postData.getBytes("UTF-8");
                os.write(input, 0, input.length);
            }
            //3. after the responseServlet.java has processed the sent data above, and have returned OK, ... or NO, ...
            //check if the string response contains the OK or the NO
            int b;//integer that will be converted to char, note that we use integer since chars don't have -1 value which is neccessary for the while condition
            ...
            this.responseTextArea.setText(responseString);
            verified[0] = responseString.contains("OK");//first part of the boolean array
            if (!verified[0]) {
            ...
            this.responseTextArea.setText("Failed: exception");
        }
    }

    private boolean checkIfVerified() {
        return verified[0] && verified[1];// return (servlet ok && jsp ok)
    }
    ...
    private void sendToJsp() {
        ...
        try {
            ...
            this.responseTextArea.setText(responseString);
            verified[1] = responseString.contains("OK");//an array to check for the double authentication
            if (!verified[1]) {
                return;
            }
            if (checkIfVerified()) {
    ...
    private java.awt.TextArea responseTextArea;
